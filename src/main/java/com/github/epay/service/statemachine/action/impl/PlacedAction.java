...
public class PlacedAction implements PaymentAction {
    ...
    public void execute(StateContext<PaymentState, PaymentEvent> context) {
        ...
        log.info("Executing PlacedAction for payment [{}]", paymentId);

        PaymentDto paymentDto = paymentStateService.paymentPlaced(paymentId);
        ...
        if (!paymentDto.getState().equals(PaymentState.CANCELED)) {
            ...
            sm.sendEvent(PaymentEvent.START_PROCESSING);
        }
    }
}
