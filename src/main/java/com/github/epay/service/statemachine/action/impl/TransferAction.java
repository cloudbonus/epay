...
public class TransferAction implements PaymentAction {
    ...
    public void execute(StateContext<PaymentState, PaymentEvent> context) {
        ...
        log.info("Executing TransferAction for payment [{}]", paymentId);

        PaymentDto paymentDto = paymentStateService.paymentTransferred(paymentId);
        ...
        if (!paymentDto.getState().equals(PaymentState.CANCELED)) {
            ...
            sm.sendEvent(PaymentEvent.COMMIT);
        }
    }
